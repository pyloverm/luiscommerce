...
const ProdutosMenuMoveis = ({Arbo2}) => {
  ...
  const data = Arbo2['familias']
  const keys = Object.keys(data['familia']);
  
  return (
    <div class="droped" id="droped-product-moveis">
                <div class="menuprod" id="product-menu2">
                    <div class="menu-link">
...
export default ProdutosMenuMoveis
